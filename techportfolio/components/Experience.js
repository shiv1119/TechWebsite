    ...
    <>
      <Row>
            <Col xs={{ span: 22, offset: 1 }} sm={{ span: 20, offset: 2 }} md={{ span: 20, offset: 2 }} lg={{ span: 18, offset: 3 }} xl={{ span: 16, offset: 4 }} style={{display:"flex",flexDirection: "column", gap:"15px", marginTop:"-10px"}}>
                <div style={{}} className='large_text'>Experience</div>
                ...
                <Timeline style={{color:"#fafafa"}}
                    ...
                    {   
                        ...
                        children: <>
                        <Slide>
                        <Row style={{ padding: "15px 0px", display:"flex", flexDirection:"row", gap:"10px"}} className='experience_gradient'>
                            <Col>
                            <Image preview={false}  width={60} style={{border:"1px solid white", borderRadius:"50%", background:"rgb(0, 78, 88)"}} src="https://media.licdn.com/dms/image/C4D0BAQHiNSL4Or29cg/company-logo_100_100/0/1631311446380?e=1726099200&v=beta&t=rqMa_4BPJeaFBksZ-tp8Dhvv_so6aSbsFd1gUD02G4g"/>
                            </Col>
                            <Col>
